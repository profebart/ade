...
Como alternativa, pode-se usar o comando "*describe*", do pacote "*psych*":
...
1.  Identificar qual é o problema a ser estudado.

2.  Pesquisar e elencar os principais possíveis fatores causadores do problema a ser estudado.

3.  Quantificar as grandezas envolvidas (dados quantitativos do problema).

4.  Ordená-los por importância decrescente de relevância de forma acumulada, agrupadas por grupos de afinidades ou causas.

5.  Determinar a magnitude total do problema.

6.  Identificar os percentuais relativos de cada classe ou grupo.

7.  Plotar um gráfico de barras de duplo eixo, sendo:
...
8.  Pareto para as possíveis causas de furo de pneus de caminhão.
