...
Para ilustrar um pouco mais o acima exposto, considere uma turma que realizou testes na escrita de textos em sala de aula, com 29 alunos, e que tenham seus desempenhos relativizados com base no número de erros cometidos. A figura a seguir mostra os casos onde há perda de simetria da curva gaussiana (normalidade), onde podemos notar que a distribuição dos dados altera a importância relativa de se utilizar valores médios para representar a turma como um todo (note que há diferenças significativs ebtre média e mediana nas distribuições com desvios negativos e positivos):

![](images/mediamodamediana.png)
