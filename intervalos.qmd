...
$$ \chi² = \frac{(n-1)s²}{\sigma²}$$ Considerando um caso aleatório em que haja, por exemplo, 5 graus de liberdade (n=6), temos a seguinte curva característica da distribuição:
