...
dados<-read_xlsx("C:/Users/ericb/OneDrive/Documentos/ADE_github/dados/dados_lucro_publicidade.xlsx")
str(dados)
```
...
```{r, c3433}
delivery<-read_xlsx("C:/Users/ericb/OneDrive/Documentos/ADE_github/dados/dados_delivery.xlsx")  
str(delivery)
```
